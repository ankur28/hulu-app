...
const Thumbnail = forwardRef(({ result },ref) => {
    ...
    return (
        <div ref={ref} className="group cursor-pointer p-2  transition duration-200 
            ...
            layout="responsive" 
            /* console.log(result)
                result is showing what is coming from the tmdb website , poster_source , backdrop_path are elemtns of result object
             */
            src={
            ...
            width={1920}
             ...
             <div className="p-2">
                 ...
                 <h2 className="mt-1 text-2xl text-white transition-all 
                    duration-100 ease-in-out hover:font-bold">
